            ...
            <div class="p-2 md:p-4">
                ...
                <div class="items-center  text-[#202142]">
                    <div class="mb-2 sm:mb-6">
                        <label for="email" class="block mb-2 text-sm font-medium text-indigo-900 ">Nama</label>
                    ...
                    <div class="mb-2 sm:mb-6">
                        <label for="profession" class="block mb-2 text-sm font-medium text-indigo-900 ">Password</label>
                    ...
                    <div class="mb-6">
                        <label for="message" class="block mb-2 text-sm font-medium text-indigo-900 ">Alamat</label>
